...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.cars_manager' => 'getApp_CarsManagerService',
    ...
    /**
     * Gets the 'app.cars_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\CarsManager A AppBundle\Manager\CarsManager instance.
     */
    protected function getApp_CarsManagerService()
    {
        return $this->services['app.cars_manager'] = new \AppBundle\Manager\CarsManager(($this->targetDirs[2].'/../web/data/cars.json'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ySXAZWsUi2bYGdPMknfZ8LaXPwAT1CDa');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.secret' => 'ySXAZWsUi2bYGdPMknfZ8LaXPwAT1CDa',
